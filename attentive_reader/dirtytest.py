...
vocab = du.create_vocdicts(filelist)
data, count, dictionary, reverse_dictionary = du.build_dataset(vocab,100)
data_label = du.generate_label(data,dictionary)
...
#        batch_size, num_skips, skip_window)
    batch_data = du.randombatch(data_label, batch_size)
